...
def import_data(directory_path=None):
    ...
    while True:
        ...
        try:
            ...
            if not valid_files:
                print(f"No supported data files found in '{directory_path}'")
    ...
    while True:
        try:
            ...
            if num_files < 1:
                ...
                print(f"You can select at most {len(file_list)} files.")
            else:
                break
        ...
        while True:
            try:
                ...
                if any(filename == fname for fname, _ in selected_data):
                    print(f"'{filename}' already selected. Choose a different file.")
                    continue
                ...
                if data is not None:
                    ...
                    print(f"Failed to load {filename}. Please select another file.")
                ...
                try:
                    ...
                    for item in [x.strip() for x in column_input.split(',')]:
                        ...
                        # Otherwise, treat as column name
                            ...
                            print(f"Column '{item}' not found. Please try again.")
                            selected_columns = []
                            break
